            ...
            <div class="w-[95%] grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="w-full h-auto">
                    <form action="" method="post" class="w-full flex flex-col gap-5">
                        ...
                        <button type="button" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 capitalize">
                            send message
                        </button>
                    </form>
                </div>
